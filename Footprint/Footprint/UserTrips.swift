...
class UserTrips: UITableView, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel!.text = "On \(end_time_arr[0]), you saved \(emissions)g of Carbon by walking \(distance_walked) while driving a \(car_type) in \(city)."
